...
import bayu.learnprogramming.dog.model.DogDao
import bayu.learnprogramming.dog.model.DogDatabase
import bayu.learnprogramming.dog.model.DogsApiService
import bayu.learnprogramming.dog.util.NotificationsHelper
import bayu.learnprogramming.dog.util.SharedPrefencesHelper
...
class ListViewModel(application: Application): BaseViewModel(application) {
    ...
    private var prefHelper = SharedPrefencesHelper(getApplication())
