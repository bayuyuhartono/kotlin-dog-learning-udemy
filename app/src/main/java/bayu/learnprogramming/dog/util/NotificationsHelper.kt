package bayu.learnprogramming.dog.util
...
import bayu.learnprogramming.dog.view.MainActivity
...
class NotificationsHelper(val context: Context) {
    ...
    fun createNotification() {
        ...
        // intent untuk apa yg dibuka setelah click notif
        ...
        val notification = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setContentText("This Notifications has some contents")
            .setStyle(
